			...
			<div class="ilmuboard">
				...
				<div class="isi">
					<div class="ilmu-author">
						<a style="cursor: pointer !important;" onclick="alert('Kamu harus terdaftar menjadi Tandurarian')" class="nama-author"><?= $el['username'];?></a><p class="tanggal-artikel"><?= $el['postDate'];?></p>
						<div class="laporan-btn">
							<a class="laporan" style="cursor: pointer !important;" onclick="alert('Kamu harus terdaftar menjadi Tandurarian')">Laporkan artikel</a>
						</div>
					</div>
